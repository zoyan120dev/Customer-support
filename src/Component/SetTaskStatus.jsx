  ...
  return (
    <>
     ...
     <div className='space-y-3'>
         {
        purchesItems.map(UpdateItems => <TaskStatus  RemoveButtonData={RemoveButtonData}  key={UpdateItems.id} UpdateItems={UpdateItems} handelclikedButton={handelclikedButton}/>)
      }
     </div>
    </>
  )
